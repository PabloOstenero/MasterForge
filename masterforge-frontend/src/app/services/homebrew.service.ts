...
export class HomebrewService {
  ...
  createClassFeature(dto: { name: string; description: string; levelRequired: number; actionType?: string; classId: number; options?: any; progression?: any; properties?: any }): Observable<any> {
    const { classId, ...rest } = dto;
    return this.http.post<any>('/api/class-features', { ...rest, dndClassId: classId });
  }

  updateClassFeature(id: number, dto: { name: string; description: string; levelRequired: number; actionType?: string; classId: number; options?: any; progression?: any; properties?: any }): Observable<any> {
    const { classId, ...rest } = dto;
  ...
  createRaceTrait(dto: { name: string; description: string; levelRequired: number; actionType?: string; raceId: number; options?: any; progression?: any; properties?: any }): Observable<any> {
    return this.http.post<any>('/api/race-traits', dto);
  }

  updateRaceTrait(id: number, dto: { name: string; description: string; levelRequired: number; actionType?: string; raceId: number; options?: any; progression?: any; properties?: any }): Observable<any> {
